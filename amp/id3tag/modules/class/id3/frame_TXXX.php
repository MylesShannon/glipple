...
class frame_TXXX extends frame {	// Special Frame, so it is not the same pattern as T Frame
	protected $tagcode = 'TXXX';
	protected $tagname = 'User defined text information frame';
	...
	public function display_spec() {	// Same as frame_T
	...
	public function save($code) {
		...
		$buffer .= frame::text2code($code['spec'][0],frame::check_newline($code['data'][1],false));		// Value
		$size = strlen($buffer);
