...
class LoginModel
{
    ...
    public function registerNewUser()
    {
        ...
        if (!$this->checkCaptcha()) {
            ...
            $sql = "INSERT INTO users (user_name, user_password_hash, user_email, user_tos, user_creation_timestamp, user_activation_hash, user_provider_type)
                    VALUES (:user_name, :user_password_hash, :user_email, :user_tos, :user_creation_timestamp, :user_activation_hash, :user_provider_type)";
