...
<?php
	...
	while ($row = mysql_fetch_array($result)) {
		...
		echo "<td><form action='delete.php?artist=".$row['artist']."&title=".$row['title']."'><input type='sumbit' id='row-".$count."-delete' name='row-".$count."-delete' value='delete'>delete</input></form></td>";
		echo "</tr>";
		$count++;
	}
