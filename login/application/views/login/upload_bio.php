...
mysql_query("INSERT INTO $table (id, user_id, band_image, band_bio, timestamp) VALUES (NULL, '$userID', NULL, '$bio', NULL) ON DUPLICATE KEY UPDATE band_bio = '$bio'") or die(mysql_error());
