...
define('COOKIE_DOMAIN', '.glipple.com');
...
define("EMAIL_USE_SMTP", true);
// name of your host
define("EMAIL_SMTP_HOST", 'email-smtp.us-west-2.amazonaws.com');
// leave this true until your SMTP can be used without login
define("EMAIL_SMTP_AUTH", true);

// SMTP provider username
define("EMAIL_SMTP_USERNAME", 'AKIAI4ZAJOYVAPQ4FD4A');
//define("EMAIL_SMTP_USERNAME", null);

// SMTP provider password
define("EMAIL_SMTP_PASSWORD", 'AsLusDdRWWibqQcSDQw5extzfGCRis5pDrnktumcDo34');
// SMTP provider port
define("EMAIL_SMTP_PORT", 465);
...
define("EMAIL_PASSWORD_RESET_FROM_EMAIL", "no-reply@glipple.com");
define("EMAIL_PASSWORD_RESET_FROM_NAME", "Glipple, Inc.");
define("EMAIL_PASSWORD_RESET_SUBJECT", "Password reset for Glipple");
define("EMAIL_PASSWORD_RESET_CONTENT", "Please click on this link to reset your password: ");

define("EMAIL_VERIFICATION_URL", URL . "login/verify");
define("EMAIL_VERIFICATION_FROM_EMAIL", "no-reply@glipple.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Glipple, Inc.");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Glipple");
define("EMAIL_VERIFICATION_CONTENT", "Please click on this link to activate your account: ");
